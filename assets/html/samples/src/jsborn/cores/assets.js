...
(function(window) {
	...
	//Check whether you want to load jsrender.
	if (jQuery&&!jQuery.templates) 
	{
		_ary_imports.push("jquery.plugins.jsrender");
	}

	JSB.extendCore("assets", JSB.cls("jsborn.core.assets", {

		imports: _ary_imports,
		...
		initialize: function(options) {
			...
			if (!jQuery.templates) {
				JSB.echo("error", "Before use jsborn.core.assets. please loading jsrender.js.");
			}
